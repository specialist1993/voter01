        ...
        <div class="flex items-center justify-between gap-5 p-4  ">
          ...
          <div class="relative">
            ...
            <input
              ...
              class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-70 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"
